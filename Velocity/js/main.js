$(document).ready(function () {
    ...
    let recSecuece =()=>{
        ...
        let secuence = [
            ...
            {elements : rec , properties : {top: '10%'} , options : {
                complete : ()=>{
    ...
    const infiniteRect =()=>{
        $('.rectangulo').velocity({rotateZ : '+10'}, {duration :100})
     ...
     let textSecuence = ()=>{
         ...
         let secuence2 = [
             ...
             //  {elements : texto , properties : {width : '0%'}}, 
             {elements : texto , properties : {width : '30%'}}, 
             {elements : texto , properties : {width : '40%'}}, 
             {elements : texto , properties : {width : '50%'}}, 
             {elements : texto , properties : {width : '60%'} ,  options : {
                 complete : ()=>{
                     generrateText();
                     recSecuece();
                     infiniteRect();
 ...
 let secuence  = [
   ...
   {elements : body,properties: {height : '100%' ,top: 0} , options : { 
     complete : ()=>{
        $('.wrap').velocity({
            opacity : 1
        },{duration: 300});
